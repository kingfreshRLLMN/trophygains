...
export const metadata: Metadata = {
  ...
  description: "Cut, maintain en bulk voedingsschema's van 1500 tot 3500 calorieën.",
};
  ...
  return (
    <>
      <PageHeader
        ...
        text="Filter op cut, maintain of bulk en kies uit 1500, 2000, 2500, 3000 of 3500 calorieën."
      />
