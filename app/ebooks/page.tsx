...
export const metadata: Metadata = {
  title: "Ebooks",
  description: "Downloadbare TrophyGains ebooks en guides voor training, voeding en discipline.",
};
  ...
  return (
    <>
      <PageHeader
        ...
        text="Downloadbare ebooks en guides voor betere keuzes in de gym, keuken en planning."
      />
